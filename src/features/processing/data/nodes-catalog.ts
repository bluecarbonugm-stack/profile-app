...
export const CATEGORIES: Category[] = [
  ...
  { id: "preproc", code: "B", label: "Pra-Pemrosesan Citra", hint: "Koreksi atmosfer, sunglint, kolom air" },
  { id: "field", code: "C", label: "Data Lapangan & Integrasi", hint: "Fishnet, spatial join, skema kelas" },
...
export const NODES: NodeSpec[] = [
  ...
  {
    id: "vector-input", name: "Vector Input (SHP)", category: "io",
    description: "Muat shapefile titik/garis/poligon (sampel, batas kajian, grid).",
    inputs: [], outputs: [p("out", "Vector", "vector")],
    params: [
  ...
  {
    id: "train-test-split", name: "Definisi Field Train/Test", category: "io",
    ...
    params: [
      ...
      { key: "mode", label: "Mode split", type: "select", options: ["Acak", "Stratified per kelas"], default: "Stratified per kelas" },
      { key: "seed", label: "Random seed", type: "number", default: 42 },
    ],
  },
  {
    id: "raster-export", name: "Raster Export", category: "io",
    description: "Simpan hasil raster ke file (GeoTIFF).",
    inputs: [p("in", "Raster", "raster")], outputs: [],
    params: [
      { key: "format", label: "Format", type: "select", options: ["GeoTIFF", "COG", "IMG"], default: "GeoTIFF" },
      { key: "compress", label: "Kompresi", type: "select", options: ["LZW", "DEFLATE", "None"], default: "LZW" },
      { key: "filename", label: "Nama file", type: "text", default: "output.tif" },
    ],
  },
  {
    id: "vector-export", name: "Vector Export", category: "io",
    description: "Simpan hasil vektor ke SHP/GeoJSON.",
    inputs: [p("in", "Vector", "vector")], outputs: [],
    params: [
      { key: "format", label: "Format", type: "select", options: ["Shapefile", "GeoJSON", "GeoPackage"], default: "Shapefile" },
      { key: "filename", label: "Nama file", type: "text", default: "output.shp" },
    ],
  },
  {
    id: "table-export", name: "Table Export", category: "io",
    description: "Simpan tabel atribut / akurasi ke CSV/XLSX.",
    inputs: [p("in", "Table", "table")], outputs: [],
    params: [
  ...
  {
    id: "atmos-correction", name: "Koreksi Atmosfer", category: "preproc",
    description: "Placeholder/pass-through: citra L2/L2A umumnya sudah terkoreksi atmosfer.",
    inputs: [p("in", "Raster", "raster")], outputs: [p("out", "Raster", "raster")],
    params: [
      { key: "method", label: "Metode", type: "select", options: ["DOS", "COST", "QUAC", "FLAASH", "Pass-through (L2A)"], default: "Pass-through (L2A)" },
    ],
  },
  {
    id: "roi-sampling", name: "Sampling ROI", category: "preproc",
    description: "Mengambil sampel piksel (sunglint, substrat) untuk regresi koreksi.",
    inputs: [p("in", "Raster", "raster")], outputs: [p("out", "Sampel", "vector")],
    params: [
      { key: "mode", label: "Mode", type: "select", options: ["Manual (klik canvas)", "Grid acak"], default: "Grid acak" },
      { key: "nSamples", label: "Jumlah sampel", type: "number", default: 200 },
      { key: "label", label: "Label ROI", type: "text", default: "Sunglint" },
    ],
  },
  {
    id: "sunglint", name: "Koreksi Sunglint (Hedley)", category: "preproc",
    ...
    params: [
      ...
      { key: "regression", label: "Metode regresi", type: "select", options: ["OLS", "Robust"], default: "OLS" },
    ],
  },
  {
    id: "ln-transform", name: "Ln Transform", category: "preproc",
    description: "Transformasi logaritma natural (persiapan koreksi kolom air Lyzenga).",
    inputs: [p("in", "Raster", "raster")], outputs: [p("out", "Raster (ln)", "raster")],
    params: [{ key: "bands", label: "Band yang ditransformasi", type: "text", default: "B2,B3,B4" }],
  },
  {
    id: "substrate-sampling", name: "Sampling Substrat Acuan", category: "preproc",
    description: "Ambil sampel substrat homogen (mis. pasir) di berbagai kedalaman.",
    inputs: [p("in", "Raster (ln)", "raster")], outputs: [p("out", "Sampel substrat", "vector")],
    params: [
  ...
  {
    id: "water-column", name: "Koreksi Kolom Air (DII)", category: "preproc",
  ...
  {
    id: "band-stack", name: "Band Stack / Komposit", category: "preproc",
    ...
    params: [{ key: "order", label: "Urutan band", type: "text", default: "B2,B3,B4,DII_B2B3,DII_B2B4,DII_B3B4" }],
  },
  {
    id: "masking", name: "Masking (Batas Kajian)", category: "preproc",
    ...
    params: [
      { key: "source", label: "Sumber mask", type: "select", options: ["Vector batas", "Threshold NoData"], default: "Vector batas" },
      { key: "invert", label: "Invert mask", type: "checkbox", default: false },
    ],
  },
  {
    id: "clip", name: "Clip / Crop Raster", category: "preproc",
  ...
  // ===== C. Field & Integrasi =====
  {
    id: "field-import", name: "Impor Data Survei Lapangan", category: "field",
    ...
    params: [
      { key: "method", label: "Metode survei", type: "select", options: ["Photo-quadrate", "Photo-transect", "CPCe"], default: "Photo-transect" },
      { key: "xField", label: "Field X (lon)", type: "text", default: "lon" },
      { key: "yField", label: "Field Y (lat)", type: "text", default: "lat" },
    ],
  },
  {
    id: "fishnet", name: "Fishnet Grid Generator", category: "field",
  ...
  {
    id: "spatial-join", name: "Spatial Join (ke Grid)", category: "field",
    ...
    params: [
      { key: "rule", label: "Aturan agregasi", type: "select", options: ["Mean", "Sum", "Majority"], default: "Mean" },
      { key: "overlap", label: "Overlap", type: "select", options: ["contains", "intersect"], default: "intersect" },
      { key: "join", label: "Kardinalitas", type: "select", options: ["one-to-one", "one-to-many"], default: "one-to-one" },
    ],
  },
  {
    id: "feature-to-point", name: "Feature to Point (Centroid)", category: "field",
    description: "Konversi grid poligon menjadi titik centroid representatif.",
    inputs: [p("in", "Grid poligon", "vector")], outputs: [p("out", "Titik", "vector")],
    params: [],
  },
  {
    id: "classification-scheme", name: "Definisi Skema Klasifikasi", category: "field",
    description: "Definisikan skema kelas mayor/detail (Terumbu, Lamun, Makroalga, Substrat...).",
    inputs: [], outputs: [p("out", "Skema", "table")],
    params: [
      { key: "level", label: "Level skema", type: "select", options: ["Mayor", "Detail"], default: "Mayor" },
      { key: "classes", label: "Daftar kelas", type: "text", default: "Terumbu Karang, Lamun, Makroalga, Substrat Terbuka" },
      { key: "rule", label: "Rule dominasi", type: "text", default: "±70% dominan, ±30% campuran" },
    ],
  },
  {
    id: "label-class", name: "Pelabelan Kelas", category: "field",
    ...
    params: [
      ...
      { key: "mode", label: "Mode", type: "select", options: ["Otomatis (rule)", "Manual"], default: "Otomatis (rule)" },
    ],
  },
  {
    id: "field-calculator", name: "Field Calculator", category: "field",
    description: "Ekspresi atribut umum (konkat, aritmatika, kondisional).",
    inputs: [p("in", "Table/Vector", "any")], outputs: [p("out", "Table/Vector", "any")],
    params: [
  ...
  // ===== D. Klasifikasi & ML =====
  {
    id: "rasterize", name: "Rasterize Vektor", category: "ml",
  ...
  {
    id: "rf-train", name: "Random Forest — Train Model", category: "ml",
    ...
    params: [
      { key: "nTree", label: "nTree", type: "select", options: ["50", "100", "200", "300", "500"], default: "300" },
      { key: "vars", label: "Pemilihan variabel", type: "select", options: ["sqrt", "log"], default: "sqrt" },
      { key: "impurity", label: "Fungsi impurity", type: "select", options: ["Gini", "Entropy"], default: "Gini" },
      { key: "grid", label: "Uji semua kombinasi", type: "checkbox", default: false },
    ],
  },
  {
    id: "classify-image", name: "Classify Image (Apply Model)", category: "ml",
  ...
  {
    id: "var-importance", name: "Variable Importance Viewer", category: "ml",
    description: "Tampilkan peringkat kontribusi tiap band terhadap model.",
    inputs: [p("model", "Model RF", "model")], outputs: [p("chart", "Chart", "chart")],
    params: [],
  },

  // ===== E. Uji Akurasi =====
  {
    id: "confusion-matrix", name: "Confusion Matrix / Accuracy", category: "accuracy",
    description: "Hitung user's / producer's / overall accuracy per kelas.",
    inputs: [p("pred", "Peta klasifikasi", "raster"), p("truth", "Raster sampel validasi", "raster")],
    outputs: [p("table", "Matriks", "table"), p("report", "Report akurasi", "chart")],
    params: [],
  },
  {
    id: "fast-accuracy", name: "Fast Accuracy Assessment", category: "accuracy",
  ...
  {
    id: "raster-to-polygon", name: "Raster to Polygon", category: "temporal",
    description: "Konversi peta klasifikasi raster menjadi poligon per kelas.",
    inputs: [p("in", "Raster kelas", "raster")], outputs: [p("out", "Poligon kelas", "vector")],
    params: [
  ...
  {
    id: "filter-attr", name: "Filter Atribut", category: "temporal",
    description: "Buang poligon unclassified (kode 0) atau area di luar mask.",
    inputs: [p("in", "Vector", "vector")], outputs: [p("out", "Vector", "vector")],
    params: [{ key: "expr", label: "Kondisi filter", type: "text", default: "gridcode != 0" }],
  },
  {
    id: "reclassify-label", name: "Reklasifikasi Label", category: "temporal",
    ...
    params: [{ key: "map", label: "Mapping", type: "text", default: "1=Terumbu; 2=Lamun; 3=Makroalga; 4=Pasir" }],
  },
  {
    id: "area-summary", name: "Kalkulasi Luas & Ringkasan", category: "temporal",
  ...
  {
    id: "overlay", name: "Union / Intersect Overlay", category: "temporal",
    ...
    params: [{ key: "op", label: "Operasi", type: "select", options: ["Union", "Intersect"], default: "Intersect" }],
  },
  {
    id: "change-field", name: "Change Field Builder", category: "temporal",
    description: "Bangun field perubahan (mis. 'Lamun → Pasir') & status.",
    inputs: [p("in", "Vector overlay", "vector")], outputs: [p("out", "Vector + change", "vector")],
    params: [
  ...
  {
    id: "timeseries-chart", name: "Time-Series Chart Builder", category: "temporal",
    description: "Grafik tren luasan kelas dari waktu ke waktu.",
    inputs: [p("in", "Tabel luasan", "table")], outputs: [p("chart", "Chart", "chart")],
    params: [{ key: "kind", label: "Tipe grafik", type: "select", options: ["Batang", "Garis", "Kombinasi"], default: "Garis" }],
  },
  {
    id: "change-symbolizer", name: "Change Map Symbolizer", category: "temporal",
    description: "Peta tematik perubahan (bertambah/berkurang/tetap).",
    inputs: [p("in", "Vector +status", "vector")], outputs: [p("out", "Peta tematik", "chart")],
    params: [{ key: "palette", label: "Skema warna", type: "select", options: ["Coral/Teal/Sand", "Diverging RdBu"], default: "Coral/Teal/Sand" }],
  },

  // ===== G. Utilitas =====
  {
    id: "reproject", name: "Reproject / CRS Transform", category: "utility",
    description: "Samakan sistem koordinat antar layer.",
    inputs: [p("in", "Raster/Vector", "any")], outputs: [p("out", "Raster/Vector", "any")],
    params: [{ key: "crs", label: "CRS tujuan", type: "text", default: "EPSG:32749" }],
  },
  {
    id: "attr-table", name: "Attribute Table Viewer", category: "utility",
    description: "Tampilkan tabel atribut layer di panel.",
    inputs: [p("in", "Table/Vector", "any")], outputs: [],
    params: [],
  },
  {
    id: "map-preview", name: "Map Preview", category: "utility",
    description: "Pratinjau layer di atas basemap interaktif.",
    inputs: [p("in", "Raster/Vector", "any")], outputs: [],
    params: [
      { key: "basemap", label: "Basemap", type: "select", options: ["OSM", "Satelit", "Gelap"], default: "Satelit" },
    ],
  },
  {
    id: "report-generator", name: "Report Generator", category: "utility",
    description: "Susun laporan otomatis (parameter, akurasi, peta) ke PDF/HTML.",
    inputs: [p("in", "Beragam", "any")], outputs: [],
    params: [{ key: "template", label: "Template", type: "select", options: ["Ringkas", "Lengkap"], default: "Ringkas" }],
  },
];
