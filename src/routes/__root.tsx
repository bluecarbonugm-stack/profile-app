...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Riset pemetaan habitat perairan laut dangkal dengan penginderaan jauh & machine learning." },
      { name: "author", content: "Blue Carbon Research Group" },
